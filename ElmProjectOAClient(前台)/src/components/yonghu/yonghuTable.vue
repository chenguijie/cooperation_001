<template>
  <div>
    <el-table :data="list" stripe>
      <el-table-column prop="id" label="用户编号" min-width="100"></el-table-column>
      <el-table-column prop="accountnumber" label="账号" min-width="100"></el-table-column>
      <el-table-column prop="password" label="密码" min-width="100"></el-table-column>
      <el-table-column prop="username" label="用户名" min-width="100"></el-table-column>
      <el-table-column prop="userhead" label="用户头像" width="200">
        <template v-slot="scope">
          <el-image
            :src="'http://localhost:50826/'+scope.row.userhead"
            fit="contain"
...
export default {
  ...
  methods: {
    loadData() {
      ...
      axios.get("/rng/UserTable/Load", {}).then(res => {
